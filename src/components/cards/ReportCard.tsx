...
return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all group">
        <div className={`w-16 h-16 ${bg} rounded-2xl flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 transition-transform`}>
        ...
        <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-100">
            ...
            <span className="text-sm font-bold text-gray-700">{countType}{count}</span>
        </div>
