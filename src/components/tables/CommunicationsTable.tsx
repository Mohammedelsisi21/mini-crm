...
import ViewCommunication from "../crud/communicationCrud/ViewCommunication"
import UpdateCommunication from "../crud/communicationCrud/UpdateCommunication"
import DeleteCommunication from "../crud/communicationCrud/DeleteCommunication"

const data = [
        { username: "أحمد محمد", contactType: "مكالمة هاتفية", employee: "سارة أحمد", status: "عاجل", description: "العميل مهتم بالخدمة ويريد معرفة الأسعار والمواعيد.", since: 4},
        { username: "فاطمة علي", contactType: "بريد إلكتروني", employee: "محمد حسن", status: "متوسط", description: "تم إرسال عرض سعر والعميلة تفاوض على السعر.", since: 3},
        { username: "عمر خالد", contactType: "اجتماع", employee: "نور الدين", status: "عادي", description: "تم الاتفاق على مشروع جديد.", since: 1},
    ]
                ...
                <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                        <div className="bg-gradient-primary w-11 h-11 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                            <span className="text-white font-bold text-sm">{communication.username[0]}</span>
                        </div>
                        <div>
                            <p className="font-bold text-gray-800">{communication.username}</p>
                        </div>
                    </div>
                </td>
                <td className="px-6 py-4">
