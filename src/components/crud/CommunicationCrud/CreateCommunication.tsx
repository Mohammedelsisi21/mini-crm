...
return (
    <>
    <Button ariaLabel="create-cummunication" w="w-fit" onClick={() => setIsOpen(true)}>
        <Plus size={20} />
        <span>إضافة تواصل</span>
    </Button>
    <CustomeModal desc="إدخال بيانات التواصل جديد." variant="create" isOpen={isOpen} setIsOpen={setIsOpen}>
    <form className="space-y-5 font-main" onSubmit={onSubmit}>
        ...
        <div>
            ...
            <Input {...register("employee")} type="text" name="employee" id="employee" pl="pl-4" error={!!errors.employee} placeholder="أدخل اسم الموظف" autoFocus icon={<User size={24}/>}/>
