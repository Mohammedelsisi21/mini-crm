...
return (
    ...
    <CustomeModal desc="تحديث بيانات المننتج." variant="create" isOpen={isOpen} setIsOpen={setIsOpen}>
    <form className="space-y-5 font-main" onSubmit={onSubmit}>
        ...
        <div className="flex gap-3 pt-4 justify-end">
            ...
            <Button ariaLabel="cancel-create" type="submit" variant="warning" w="w-fit">
                تحديث
            </Button>
        </div>
    </form>
